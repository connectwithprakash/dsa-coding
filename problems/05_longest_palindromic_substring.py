...
class Solution:
    ...
    def find_even_odd_len_palindrome(self, word_length, combinations, palindrome_indices, palindrome_word, even=False):
        ...
        for palindrome_length in range(start, word_length + 1, 2):
            ...
            for index in palindrome_indices:
                ...
                print(index, new_index, word_length - step, word_length, word_length - palindrome_length)
            ...
            if len(palindrome_new_indices) > 0 and (palindrome_length <= word_length):
                ...
                break
        # palindrome_word = combinations[true_indices[0]][:palindrome_length]
    ...
    def longestPalindrome(self, s: str) -> str:
        ...
        # pprint(combinations[:word_length - 1][9])
        ...
        #     palindrome_indices = palindrome_new_indices
        #     palindrome_word = combinations[palindrome_indices[0]][:3]
        #     step = 1
        #     start = 5
        # elif len(palindrome_indices) > 0:
        #     palindrome_word = combinations[palindrome_indices[0]][:2]
        #     step = 2
        #     start = 4
        # else:
        ...
        #     palindrome_new_indices = []
        #     for index in palindrome_indices:
        #         word = combinations[index - step]
        #         if word[0] == word[palindrome_length-1]:
        #             palindrome_new_indices.append(index - step)
        #     if len(palindrome_new_indices) > 0 and (palindrome_length <= word_length):
        #         palindrome_indices = palindrome_new_indices
        #         palindrome_word = combinations[palindrome_indices[0]][:palindrome_length]
        #     else:
